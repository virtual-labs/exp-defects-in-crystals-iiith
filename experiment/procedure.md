...
- It is required that not only the direction of the vectors chosen are right but also their magnitudes. Once the atoms are picked in the above mentioned order, the validity of the selection can be tested.
